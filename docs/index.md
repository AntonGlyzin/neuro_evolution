...
В самой программе был добавлен микрофреймворк по созданию подпроцессов и их взаимодействия между собой. Один подпроцесс отображает визуальную часть, а другой подпроцесс может обрабатывать задачи связанные с вводом выводом. Обучение же связано с нагрузкой на ЦПУ, поэтому был сделан еще один тип задач, который выполняется в отдельных подпроцессах для паралельной обработки данных. 
...
[Скачать последнюю версию](https://github.com/AntonGlyzin/neuro_evolution/releases/latest)