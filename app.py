...
class NeuroGym(object):
    ...
    def _select_save_model(self):
        ...
        user_ten = self._input_user_number(
            'Выберите десятилетие от {} до {}: '.format(start + 1, start + num_ten), 
            start + 1, start + num_ten
        )
        ...
        selected_individ = self.best_individuals[user_ten-1-start][user_individ-1]
